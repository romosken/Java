...
public class ListaItens extends javax.swing.JFrame {
     ...
     */
    public ListaItens() throws SQLException, ClassNotFoundException {
    ...
    private void listarItens() throws SQLException, ClassNotFoundException{
        ...
        {
            id = Integer.parseInt(pesquisar.getText().toString());
        }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
        Itens pesquisa = new Itens(id);
        ...
        for(Itens c: new ControleItens().listar(pesquisa)){
               modelo.addRow(new Object[]{c.getIdPedido(),c.getIdProduto(),c.getQtd()});
    ...
    private void pesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pesquisarActionPerformed
        try {
            ...
            Logger.getLogger(ListaItens.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarActionPerformed
        try {
            // TODO add your handling code here:
            int id1 = Integer.parseInt(tabela.getModel().getValueAt(tabela.getSelectedRow(), 0).toString());
            int id2 = Integer.parseInt(tabela.getModel().getValueAt(tabela.getSelectedRow(), 1).toString());
           
            Itens item = new Itens(id1,id2);
            this.setVisible(false);
            new AlterarItens(item).setVisible(true);
    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
        // TODO add your handling code here:
            ...
            try {
                int id1 = Integer.parseInt(tabela.getModel().getValueAt(tabela.getSelectedRow(), 0).toString());
                int id2 = Integer.parseInt(tabela.getModel().getValueAt(tabela.getSelectedRow(), 1).toString());
                if(JOptionPane.showConfirmDialog(null,"Deseja excluir o Item do Pedido de id: "+id1+" e Produto "+id2+"?","Exclusão!",JOptionPane.YES_NO_OPTION) == 0)
                {
                    Itens item = new Itens(id1,id2);
                    new ControleItens().excluir(item);
                    listarItens();
                }
            } catch(ArrayIndexOutOfBoundsException ex){
